document.addEventListener('DOMContentLoaded', function() {
    ...
    const adminDashboardContent = document.querySelector('.admin-dashboard-content');
    const studentDashboardContent = document.querySelector('.student-dashboard-content');
    ...
    // Call handleResize on page load to ensure correct layout
    handleResize();
});
